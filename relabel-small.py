...
class Relabel:
	...
	def create_reach_vars(self):
		...
		slope2_v[:] = self.orig_dataset["Reach_Timeseries/S_1km"][0:10]
	...
	def create_xs_vars(self):
		...
		width_v[:] = self.orig_dataset["XS_Timseries/W"][0:10, 0:5]
		...
		wse_v[:] = self.orig_dataset["XS_Timseries/H_1km"][0:10, 0:5]
